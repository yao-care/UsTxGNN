...
Indomethacin is a classic non-selective NSAID historically used for inflammatory and pain-related conditions.
The TxGNN model predicts it may be effective for **brachydactyly-syndactyly syndrome**, a rare congenital limb malformation syndrome,
but this prediction is currently supported by **0 clinical trials** and **0 publications** — the evidence pack itself flags it as a purely model-driven signal with no known mechanistic basis.
