...
Oxaprozin is not currently marketed in Taiwan/US per the records available (market status: Not marketed; total licenses: 0). No NDA or license entries are on file to summarize.
