...
No marketing authorization records are present in this Evidence Pack (`total_licenses = 0`, `market_status = Not marketed/Not Marketed`). This is inconsistent with memantine's status as a long-marketed drug in most jurisdictions and should be treated as a **data gap requiring verification** rather than a confirmed absence of approval.
