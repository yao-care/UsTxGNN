...
Zinc sulfate (unspecified form) is **not currently marketed** in Taiwan under this evidence pack (`market_status: Not marketed`, `total_licenses: 0`). No NDA/license records are available for review.
