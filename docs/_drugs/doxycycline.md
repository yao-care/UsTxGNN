...
Doxycycline currently holds **no marketing authorizations** on file in this evidence pack (`total_licenses = 0`, market status = Not marketed/Not Marketed). No license records are available to summarize.
