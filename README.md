# UsTxGNN - United States: Drug Repurposing

> 本專案由 **藥提醒科技有限公司**（[yao.care](https://www.yao.care)）開發與維運。
> UsTxGNN 站台：<https://ustxgnn.yao.care/>｜產品總覽：<https://www.yao.care/medical/txgnn/>

[![Website](https://img.shields.io/badge/Website-ustxgnn.yao.care-blue)](https://ustxgnn.yao.care)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)

Drug repurposing predictions for United States FDA-approved drugs using the TxGNN model.
...
| **DHI Data** | 35 |
| **DDSI Data** | 8,359 |
| **FHIR Resources** | 944 MK / 5,706 CUD |
...
| **L5** | 944 | Computational prediction only |
...
| Metric | Value |
|------|------|
| FDA Total Drugs | 104,047 |
| Mapped to DrugBank | 91,376 (87.8%) |
| Repurposing Candidates | 5,706 |

### Deep Learning Method

```bash
conda activate txgnn
PYTHONPATH=src python -m ustxgnn.predict.txgnn_model
```

| Metric | Value |
|------|------|
| Total DL Predictions | 3,744,232 |
| Unique Drugs | 1,662 |
| Unique Indications | 17,041 |
...
flowchart TD
    ...
    subgraph B["Step 1: DrugBundle Collector"]
        B1["Drug-level: FDA, DDI, DrugBank"]
...
```mermaid
flowchart TD
    FDA["FDA Data"] --> proc["process_fda_data.py"]
    TxGNN["TxGNN Data"] --> prep["prepare_external_data.py"]

    proc --> json["us_fda_drugs.json"]
...
```bibtex
@software{ustxgnn2026,
  author       = {Yao.Care},
  title        = {UsTxGNN: Drug Repurposing Validation Reports for United States FDA Drugs},
  year         = 2026,
  publisher    = {GitHub},
  url          = {https://github.com/yao-care/UsTxGNN}
}
```
