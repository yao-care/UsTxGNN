...
No marketing authorization records are present in this dataset (`total_licenses = 0`, `market_status = Not marketed/Not marketed`). This does not necessarily reflect ofatumumab's actual global regulatory history — it reflects a gap in the source registry used to build this evidence pack.
