...
- `us_regulatory`: FDA approval and market status in the United States
...
| Item | Content |
|------|------|
| Original Indication | [Extract from us_regulatory.licenses, use first non-empty approved_indication_text] |
...
| US Market Status | [Extract from us_regulatory.market_status] |
| Number of NDAs | [Extract from us_regulatory.total_licenses] |
...
Extract from `us_regulatory.licenses` and create table:

| Authorization Number | Product Name | Dosage Form | Approved Indication |
|---------|------|------|-----------|
| NDA XXXXX | Product name | Form | Indication summary |
...
| Authorization Number | Product Name | Dosage Form | Approved Indication |
|---------|------|------|-----------|
| NDA XXXXX | TS-One | Capsule | Gastric cancer, pancreatic cancer, colorectal cancer, NSCLC... |
