...
Disopyramide currently has no registered marketing authorizations in Taiwan (market status: Not marketed / Not Marketed; 0 total licenses on file), so no NDA/license table can be produced.
