...
Currently no marketing authorization records available. `taiwan_regulatory.total_licenses = 0`; the drug is recorded as **not marketed** (Not marketed) in this jurisdiction's regulatory data.
