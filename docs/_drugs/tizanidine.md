...
Tizanidine currently holds **no TFDA license** and is **not marketed in Taiwan** (`market_status: Not marketed`, `total_licenses: 0`). No product/dosage-form data is available for this evidence pack.
