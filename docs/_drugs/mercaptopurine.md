...
No TFDA license records are present in this evidence pack — mercaptopurine's current status is recorded as **Not marketed (Not Marketed)** with **0** licenses on file.
