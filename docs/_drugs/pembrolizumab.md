...
No NDA or marketing authorization records are present in this Evidence Pack (`total_licenses = 0`, `market_status = Not marketed/Not Marketed`). No product/dosage-form/indication table can be constructed from available data.
