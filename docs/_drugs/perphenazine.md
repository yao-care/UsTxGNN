...
Perphenazine is currently **not marketed** in this jurisdiction (`market_status: Not marketed`), with **0 registered licenses/NDAs**. No product, dosage form, or approved indication text is available for tabulation.
