...
description: "How UsTxGNN produces and validates predictions: TxGNN knowledge graph prediction, evidence collection, L1-L5 grading, and decision recommendations."
---
...
<p class="key-answer" data-question="How does UsTxGNN produce its predictions?">
...
<li><strong>Evidence collection</strong>: for each predicted pair, evidence is gathered from ClinicalTrials.gov, PubMed, DrugBank and FDA.</li>
...
Drug approval data for United States comes from FDA. Ingredient names are mapped to the
