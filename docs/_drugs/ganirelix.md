...
No marketing authorization (NDA/license) records are available in this data pack — `market_status` is recorded as "Not marketed" (not marketed) with 0 total licenses on file.
