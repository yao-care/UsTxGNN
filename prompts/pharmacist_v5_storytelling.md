...
- `taiwan_regulatory`: FDA approval and market status in the United States
...
| US Market Status | [Extract from taiwan_regulatory.market_status] |
| Number of NDAs | [Extract from taiwan_regulatory.total_licenses] |
