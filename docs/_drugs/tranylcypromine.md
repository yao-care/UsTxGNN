...
Tranylcypromine currently holds **no active NDA on file** in this evidence pack (`market_status: Not marketed / Not Marketed`, `total_licenses: 0`). No dosage form or approved-indication text is available for extraction.
