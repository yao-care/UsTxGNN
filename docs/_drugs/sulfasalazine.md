...
Sulfasalazine currently has **no license records** in this evidence pack (`market_status: Not marketed`, `total_licenses: 0`). No authorization data is available to tabulate.
